...
description: "通过 trellis mem CLI 回溯过往 AI 对话历史。适用于'上次怎么解决的'、'之前讨论过吗'、'当时做了什么决定'、'提醒我这个任务做了些什么'等场景，或在需求脑暴与之前的工作重叠、调试熟悉的 Bug、跨会话继续任务、完成工作总结时使用。返回原始对话记录，由你自行决定是更新 spec、追加到任务笔记、在回答中引用，还是仅内化吸收。"
---
