...
const appMessages = {
  en: {
    ...
    webdavDownload: 'Download backup',
    webdavDownloadCancel: 'Cancel',
    webdavDownloadConfirm: 'Restore selected backup',
    webdavDownloadFail: 'Restore failed',
    webdavDownloadNotFound: 'Remote settings file not found.',
    webdavDownloadWarning: 'The selected backup will replace your local settings and blocked words.',
    webdavDownloadBusy: 'Restoring...',
    webdavDownloadSuccess: 'Backup restored.',
    webdavEnable: 'Enable WebDAV sync',
    webdavBackupSelectorLabel: 'Select a backup',
    webdavLegacyBackup: 'Legacy backup',
    webdavLegacyUnreadable: 'The legacy single-file backup could not be read. Newer backups are still available.',
    webdavLastSync: 'Last sync',
    webdavListBusy: 'Loading backups...',
    webdavListEmpty: 'No backups are available in this folder.',
    webdavListFail: 'Could not load backups',
    webdavNeverSynced: 'Never synced',
    webdavPassword: 'Password',
    webdavPath: 'Sync path',
    webdavPathInvalid: 'Enter a valid folder path.',
    webdavSave: 'Save',
    webdavSaveSuccess: 'Saved.',
    webdavSelectedBackupNotFound: 'The selected backup is no longer available.',
    ...
    webdavUploadCleanupPartial: 'Settings uploaded, but cleanup did not finish.',
  ...
  'cmn-CN': {
    ...
    webdavDownloadConfirm: '恢复所选备份',
    webdavDownloadFail: '恢复失败',
    webdavDownloadNotFound: '远端设置文件不存在。',
    webdavDownloadWarning: '所选备份将覆盖本地设置和屏蔽词。',
    webdavDownloadBusy: '恢复中...',
    webdavDownloadSuccess: '已恢复备份。',
    webdavEnable: '启用 WebDAV 同步',
    webdavBackupSelectorLabel: '选择备份',
    webdavLegacyBackup: '旧版备份',
    webdavLegacyUnreadable: '旧版单文件备份无法读取，仍可使用较新的备份。',
    webdavLastSync: '上次同步',
    webdavListBusy: '备份列表加载中...',
    webdavListEmpty: '此文件夹中暂无可用备份。',
    webdavListFail: '读取备份列表失败',
    webdavNeverSynced: '从未同步',
    webdavPassword: '密码',
    webdavPath: '同步路径',
    webdavPathInvalid: '请输入有效的文件夹路径。',
    webdavSave: '保存',
    webdavSaveSuccess: '已保存。',
    webdavSelectedBackupNotFound: '所选备份已不存在。',
    ...
    webdavUploadCleanupPartial: '设置已上传，但旧备份清理未完成。',
  ...
  'cmn-TW': {
    ...
    webdavDownload: '下載備份',
    webdavDownloadCancel: '取消',
    webdavDownloadConfirm: '還原所選備份',
    webdavDownloadFail: '還原失敗',
    webdavDownloadNotFound: '遠端設定檔不存在。',
    webdavDownloadWarning: '所選備份將覆蓋本機設定和屏蔽詞。',
    webdavDownloadBusy: '還原中...',
    webdavDownloadSuccess: '已還原備份。',
    webdavEnable: '啟用 WebDAV 同步',
    webdavBackupSelectorLabel: '選擇備份',
    webdavLegacyBackup: '舊版備份',
    webdavLegacyUnreadable: '舊版單檔備份無法讀取，仍可使用較新的備份。',
    webdavLastSync: '上次同步',
    webdavListBusy: '備份清單載入中...',
    webdavListEmpty: '此資料夾目前沒有可用備份。',
    webdavListFail: '讀取備份清單失敗',
    webdavNeverSynced: '從未同步',
    webdavPassword: '密碼',
    webdavPath: '同步路徑',
    webdavPathInvalid: '請輸入有效的資料夾路徑。',
    webdavSave: '儲存',
    webdavSaveSuccess: '已儲存。',
    webdavSelectedBackupNotFound: '所選備份已不存在。',
    ...
    webdavUploadCleanupPartial: '設定已上傳，但舊備份清理未完成。',
  ...
  jyut: {
    ...
    webdavDownloadWarning: '所選備份會覆蓋本地設定同屏蔽詞。',
    webdavDownloadBusy: '還原緊...',
    webdavDownloadSuccess: '已還原備份。',
    webdavEnable: '啟用 WebDAV 同步',
    webdavBackupSelectorLabel: '揀一個備份',
    webdavLegacyBackup: '舊版備份',
    webdavLegacyUnreadable: '舊版單檔備份讀唔到，較新備份照樣可以用。',
    webdavLastSync: '上次同步',
    webdavListBusy: '載入備份清單緊...',
    webdavListEmpty: '呢個資料夾暫時冇可用備份。',
    webdavListFail: '讀取備份清單失敗',
    webdavNeverSynced: '從未同步',
    webdavPassword: '密碼',
    webdavPath: '同步路徑',
    webdavPathInvalid: '請輸入有效嘅資料夾路徑。',
    webdavSave: '儲存',
    webdavSaveSuccess: '已儲存。',
    webdavSelectedBackupNotFound: '所選備份已經唔存在。',
    webdavSettings: 'WebDAV 設定',
    webdavTestConnection: '測試連線',
    webdavTestFail: '連線失敗',
    webdavTestBusy: '測試緊...',
