...
This directory contains the project's frontend conventions for Vue 3, TypeScript, browser-extension entrypoints, composables, Pinia state, styling, type safety, and quality checks.
